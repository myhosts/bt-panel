								...
								content: {
									...
									template: function () {
										...
										return ((0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd40 ssl-con-box') },
											...
											this.$ul({ className: 'explainDescribeList pd15' }, [['自签证书访问步骤：'], ['1. 部署SSL证书'], ['2. 浏览器地址栏修改为https://访问'], ['3. 如提醒风险（正常现象）点击【高级】或【详情】如下图：'], ['4.【继续访问】或【接收风险并继续】'], [(0, snabbdom_1.jsx)("img", null)]]),
											(0, snabbdom_1.jsx)("div", { class: { pt10: true } },
												...
												this.$ul({ className: 'sslSafeTips' }, [[(0, snabbdom_1.jsx)("span", null,
													"\u5F00\u542F\u540E\u5BFC\u81F4\u9762\u677F\u4E0D\u80FD\u8BBF\u95EE\uFF0C\u53EF\u4EE5\u70B9\u51FB\u67E5\u770B",
													this.$link({ title: '解决方法', href: 'https://www.bt.cn/bbs/thread-117246-1-1.html' }))], ['自签证书不被浏览器信任，显示不安全是正常现象']]))));
									},
									methods: {
										changeCertType: function () {
											...
											this.cert_type = Number($(event.target).val())
										},
									},
								},
		...
		Config.prototype.sslSelfJumpView = function () {
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							that = this, refreshUrl = location.href.replace(/^http:/, 'https:');
							return [4, this.$open({
								title: '跳转提醒',
								area: ['450px', '250px'],
								btn: false,
								...
								content: {
									...
									template: function () {
										return ((0, snabbdom_1.jsx)("div", { class: this.$class('ssl-jump-view pd20 f14'), style: this.$style('line-height:35px;') },
											(0, snabbdom_1.jsx)("div", { style: this.$style('font-size:12px;') }, this.$ul({ className: 'explainDescribeList' }, [[(0, snabbdom_1.jsx)("span", null,
												"\u5F00\u542F\u540E\u5BFC\u81F4\u9762\u677F\u4E0D\u80FD\u8BBF\u95EE\uFF0C\u53EF\u4EE5\u70B9\u51FB\u67E5\u770B",
												this.$link({ title: '解决方法', href: 'https://www.bt.cn/bbs/thread-117246-1-1.html' }))], ['自签证书不被浏览器信任，显示不安全是正常现象']])),
											...
											return __awaiter(this, void 0, void 0, function () {
												...
												return __generator(this, function (_b) {
													switch (_b.label) {
														...
														]),that.$request('savePanelSsl', { privateKey: privateKey, certPem: certPem })];
														case 1:
															_b.sent();
							...
							switch (_d.label) {
								...
								case 18:
									if (checked) {
										...
										bt.input_confirm({ title: '关闭面板SSL', msg: '关闭SSL极易被抓包攻击导致账号密码泄露，请勿关闭', value: '我要关闭' }, function () { return __awaiter(_this, void 0, void 0, function () {
											var rdata;
											return __generator(this, function (_a) {
												switch (_a.label) {
